...
import { Users, Building2, CalendarDays, Tag } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        ...
        const [membersRes, estRes, eventsRes, promosRes, chartRes, rmRes, reRes] = await Promise.all([
        ...
        setStats({
          ...
          establishments: {
            ...
            pro: estData.filter((e: any) => e.is_pro).length,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <MetricCard icon={Users} label="Membres inscrits" value={String(stats?.members ?? 0)} />
        <MetricCard
          icon={Building2}
