...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-dark-bg text-gray-100">
      <header className="fixed top-0 left-0 right-0 z-50 h-14 bg-dark-surface border-b border-dark-border flex items-center px-4">
        <button
        ...
        <button onClick={handleQuit} className="flex items-center gap-2 text-sm text-gray-400 hover:text-white transition-colors">
          <LogOut size={16} />
      ...
      <aside className={`fixed top-14 bottom-0 left-0 z-40 w-60 bg-dark-surface border-r border-dark-border overflow-y-auto transition-transform md:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
